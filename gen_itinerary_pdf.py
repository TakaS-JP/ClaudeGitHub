...
note("○ 国際大会の事前登録は完了済み（現地登録ブースでの手続きは不要）。日程表の「登録」欄は登録デスク開設時間の参考。", GREEN)
...
table(["日付", "主な公式行事", "333複合地区／333-E地区 関連行事（出席）"],
      [["7/3(金)", "香港着(22:35)、登録、展示ホール", "—"],
       ...
       ["7/6(月)", "○閉会式(閉会総会・ガバナー就任)、選挙、MJF昼食会", "○鈴木ガバナーを励ます夕べ"],
       ["7/7(火)", "国際役員との集い", "—"],
       ["7/8(水)", "帰国（成田15:10着）", "—"]],
      [16, 58, 70])
...
table(["時刻", "行事", "会場／備考"],
      [["9:00〜17:00", "登録", "アジアワールド・エキスポ"],
       ...
       ["15:00〜17:30", ("○【出席】閉会式（鈴木ガバナーエレクトがリボンを外し新ガバナー就任）", GREEN), "アジアワールド・エキスポ／本大会のハイライト"],
